...
def contact_us_adm(request):
    ...
    return render(request, 'tem/contact_us_adm.html', {'hth': hth})
...
def add_contact_adm(request):
    ...
    return render(request, 'tem/add_contact_adm.html')
...
def edit_contact_adm(request, id):
    ...
    if request.method == 'POST':
        ...
        return redirect('contact_us_adm')
    return render(request, 'tem/edit_contact_adm.html',{'dvd':dvd})
